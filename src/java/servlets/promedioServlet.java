...
public class promedioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int exp= Integer.parseInt(request.getParameter("expar"));
        int exf= Integer.parseInt(request.getParameter("exfin"));
        int tarea= Integer.parseInt(request.getParameter("promt"));
        
        double promedio = (exp+exf+tarea)/3;
